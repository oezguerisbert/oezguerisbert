...
Paused projects: (Domains are not accessible, but you can visit the repo!)
- taxi-kasse.de (doing a rewrite, I don't know when I will launch it) ► [REPO](https://github.com/oetzilabs/taxi-kasse.de)
- plaaaner.com (long time side project, I don't know when I will launch it) ► [REPO](https://github.com/oetzilabs/plaaaner.com)
